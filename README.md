...
### 1. หน้าแดชบอร์ดและคิวตรวจแบบ Real-time (Dashboard & Live Queue)
แสดงสถิติสรุปยอดนัดหมายประจำวัน, จำนวนแพทย์ที่เข้าตรวจ, การแจกแจงสถานะคิว และตารางคิวคนไข้วันนี้

![Dashboard](docs/dashboard.JPG)

---

### 2. ระบบนัดหมายและขั้นตอนการจอง (Appointments & Booking Wizard)

#### 2.1 รายการนัดหมายทั้งหมด (Appointments Directory)
ตารางรายการนัดหมายผู้ป่วยนอก พร้อมระบบค้นหาด่วน และตัวกรองตามวันที่, แพทย์, แผนก และสถานะการนัดหมาย

![Appointments List](docs/appointments.JPG)

#### 2.2 ขั้นตอนการเลือก Slot เวลาว่าง (Interactive Booking Wizard)
หน้าต่างจองนัดหมาย 4 ขั้นตอน พร้อมระบบคำนวณและแสดง Slot เวลาว่างที่ตัดช่วงพักเบรกและการจองซ้อนออกอัตโนมัติ

![Booking Wizard Slot Picker](docs/new_appointments.JPG)

---

### 3. การจัดการตารางตรวจแพทย์และวันลา (Doctor Schedules & Overrides)

#### 3.1 ตารางตรวจประจำสัปดาห์ (Weekly Timetable)
แสดงวันและเวลาตรวจประจำสัปดาห์ของแพทย์แต่ละท่าน เพื่อให้เจ้าหน้าที่จัดสรรคิวได้อย่างแม่นยำ

![Doctor Schedules](docs/doctor_schedules.JPG)

#### 3.2 กำหนดและแก้ไขช่วงเวลาตรวจ (Schedule Configuration)
หน้าต่างตั้งค่าเวลาเริ่ม-สิ้นสุด, ช่วงเวลาพักเบรก และกำหนดเพดานรับคนไข้สูงสุดรายวัน (`max_appointments`)

![Edit Schedule](docs/edit_schedules.JPG)

#### 3.3 ตารางยกเว้นและวันลาแพทย์ (Schedule Overrides)
บันทึกวันหยุดแพทย์, วันลาประชุมวิชาการ หรือเวลาออกตรวจพิเศษ ซึ่งจะมีผลทับตารางประจำสัปดาห์โดยอัตโนมัติ

![Schedule Overrides](docs/override.JPG)

---

### 4. ทะเบียนผู้ป่วยและประวัติการรักษา (Patient Management)

#### 4.1 ทะเบียนรายชื่อผู้ป่วย (Patient Directory)
ค้นหาข้อมูลผู้ป่วยได้อย่างรวดเร็วด้วยชื่อ-นามสกุล, รหัสประจำตัวคนไข้ (HN), เบอร์โทรศัพท์ หรือเลขบัตรประชาชน

![Patients List](docs/patients.JPG)

#### 4.2 ลงทะเบียนผู้ป่วยใหม่ (Patient Registration)
ฟอร์มลงทะเบียนคนไข้ใหม่ พร้อมระบบสร้างรหัส Hospital Number (`HN-XXXXXX`) และบันทึกประวัติการแพ้ยา

![New Patient](docs/new_patients.JPG)

---

### 5. การจัดการข้อมูลแพทย์และแผนกการรักษา (Master Data Management)

#### 5.1 ทำเนียบแพทย์และสังกัดแผนก (Doctors Directory)
แสดงรายชื่อแพทย์ประจำโรงพยาบาล, ความเชี่ยวชาญเฉพาะทาง, เลขที่ใบอนุญาตประกอบวิชาชีพ และสถานะการปฏิบัติงาน

![Doctors List](docs/doctor.JPG)

#### 5.2 เพิ่มข้อมูลแพทย์ใหม่ (New Doctor)
ฟอร์มบันทึกประวัติแพทย์ใหม่ พร้อมระบบตรวจสอบความซ้ำซ้อนของเลขที่ใบอนุญาต

![New Doctor](docs/new_doctor.JPG)

#### 5.3 รายชื่อแผนกการรักษา (Departments)
แสดงรายการแผนกการรักษาและอาคาร/สถานที่ตั้งภายในโรงพยาบาล

![Departments](docs/department.JPG)

#### 5.4 เพิ่มแผนกการรักษาใหม่ (New Department)
ฟอร์มสร้างและเปิดใช้งานแผนกการรักษาใหม่

![New Department](docs/new_department.JPG)
